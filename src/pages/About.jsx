      ...
      <section className="bg-richblack-700 text-white">
        <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center">
          <header className="mx-auto py-20 text-4xl font-semibold lg:w-[70%]">
            ...
            DYP-Connect pioneers innovation in online education, leading the way towards a brighter future. 
            Fueled by our passion for excellence, we provide dynamic courses, harness the power of emerging technologies, and foster a vibrant learning ecosystem. 
            Join us in shaping the future at D Y Patil College of Engineering and Technology, Kolhapur.
            </p>
          </header>
